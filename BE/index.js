...
app.use(cors({
    origin: ['https://rakit-cita-be.vercel.app', 'http://localhost:5173', 'https://tutam-9-sbd-fe.vercel.app', 'http://192.168.1.73:5173', 'http://localhost:3000', 'http://localhost:5173'], // Sesuaikan dengan origin frontend Anda
